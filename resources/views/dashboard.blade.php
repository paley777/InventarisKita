    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="p-6 mt-8 bg-white rounded-lg shadow-lg">
                <h3 class="text-lg font-medium text-gray-700">Statistik Inventaris</h3>
                <div class="mt-4">
                    <!-- Example of a chart (can be implemented with a chart library like Chart.js) -->
                    <div class="flex items-center justify-center h-64 text-gray-500 bg-gray-100 rounded-lg">
                        <span>Grafik Statistik Inventaris di sini</span>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="space-y-4">
                        ...
                        @foreach ($recentActivities as $activity)
                            <li class="flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-700">{{ $activity->description }}</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
